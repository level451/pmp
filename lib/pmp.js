...
//        upnp.AddMapping(callback,gateway, function(err) {
//
//                if (err) throw err;
//
//                console.log("Success");
...
//        server.send(message, 0, 2, 5351, gateway.ip,function(err, bytes) {
        server.send(message, 0, 2, 5352, gateway.ip,function(err, bytes) {
